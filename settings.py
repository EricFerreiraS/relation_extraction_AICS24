...
MODEL = 'densenet161'                          # model arch: resnet18, alexnet, resnet50, densenet161,  resnset152
DATASET = 'imagenet'                       # model trained on: places365 or imagenet
DATASET_TRANS = 'cifar10'                     #act40 or cifar10
...
if MODEL != 'alexnet':
    DATA_DIRECTORY = '/home/eric/workspace/net-dissection-lite/dataset/broden1_224'
    IMG_SIZE = 224
else:
    DATA_DIRECTORY = '/home/eric/workspace/net-dissection-lite/dataset/broden1_227'
    IMG_SIZE = 227
...
if MODEL == 'resnet18':
    ...
    if DATASET == 'places365':
        MODEL_FILE = '/home/eric/workspace/net-dissection-lite/zoo/resnet18_places365.pth.tar'
        MODEL_PARALLEL = True
    elif DATASET == 'imagenet':
        MODEL_FILE = None
    ...
    if DATASET == 'places365':
        MODEL_FILE = '/home/eric/workspace/net-dissection-lite/zoo/whole_densenet161_places365_python36.pth.tar'
        MODEL_PARALLEL = False
    elif DATASET == 'imagenet':
        MODEL_FILE = None
        MODEL_PARALLEL = False
    ...
    FEATURE_NAMES = ['layer4']
    if DATASET == 'places365':
        MODEL_FILE = '/home/eric/workspace/net-dissection-lite/zoo/whole_resnet50_places365_python36.pth.tar'
        MODEL_PARALLEL = False
    elif DATASET == 'imagenet':
        MODEL_FILE = None
        MODEL_PARALLEL = False
    ...
    FEATURE_NAMES = ['features']
    if DATASET == 'places365':
        MODEL_FILE = '/home/eric/workspace/net-dissection-lite/zoo/whole_alexnet_places365_python36.pth.tar'
        MODEL_PARALLEL = False
    elif DATASET == 'imagenet':
        MODEL_FILE = None
        MODEL_PARALLEL = False
    ...
    FEATURE_NAMES = ['layer4']
    if DATASET == 'places365':
        #MODEL_FILE = 'zoo/resnet152_places365.t7'
        MODEL_FILE = None
        MODEL_PARALLEL = False
    elif DATASET == 'imagenet':
        MODEL_FILE = None
